const Form = () => {
    return (
      <div>
        <form className="lg:w-2/5 border border-slate-400 m-3  flex flex-col gap-6 lg:p-6 py-7 px-3 mt-[-7rem] lg:ml-[42rem] shadow-lg shadow-gray-400 rounded-2xl  bg-white top-72 ">

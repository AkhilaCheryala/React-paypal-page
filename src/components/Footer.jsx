...
const Footer = () => {
    ...
    return (
        <div className='lg:ml-10 text-blue-950 font-bold  mb-12 text-sm mt-[6rem] ml-2  '>
            <img src={logo} className='w-30 h-28 pl-2 ' alt='' />
            <div className='flex flex-wrap lg:flex-row lg:gap-10 gap-4 pl-2 items-center  border-b border-slate-400  mb-2 pb-2'>
                ...
                <img src={flag} className='lg:ml-[29rem] ml-10' alt='' />
            </div>

            <div className='lg:flex lg:flex-row lg:gap-10  justify-between pl-2 lg:mr-4   items-center'>
                <div className='flex  flex-wrap gap-4 mb-6 lg:gap-9'>
                ...
                <div className='flex lg:gap-4  gap-2   font-semibold '>

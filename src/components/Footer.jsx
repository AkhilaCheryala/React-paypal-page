...
const Footer =()=>{
    ...
    return(
<div className='lg:ml-10 text-blue-950 font-bold  mb-10 text-sm mt-[3rem] mx-auto  '>
    <img src={logo} className='w-24 h-24 ' alt=''/>
    <div className='flex flex-wrap lg:flex-row lg:gap-10 gap-4  items-center  border-b border-slate-300  mb-2 pb-2'>
    ...
    <div className='lg:flex lg:flex-row lg:gap-10  justify-between lg:mr-4   items-center'>
        ...
        <div className='flex gap-4 font-semibold border-t border-slate-300 '>
